...
void String::repr(std::ostream &out) {
    out << '"' << svalue << '"';
}
RefStream String::refs() {
...
bool String::is_instance(Object *obj) {
    LITHP_CHECK_TYPE(obj, String);
}
String *String::cast(Object *obj) {
    LITHP_CAST_TO_TYPE(obj, String);
}
